...
origin_dir="/Users/leidelong/competition/Porto_Seguro_Safe_Driver_Prediction/input/"
dest_dir="/Users/leidelong/competition/Porto_Seguro_Safe_Driver_Prediction/"
...
sub_df = pd.read_csv(origin_dir+"test.csv", index_col=0)
...
#以下组合方式适合bool、cat等类型组合，如果是整型也可以参与组合
...
sub_df[["target"]].to_csv(dest_dir+"submission_20fold.csv", index=True, float_format="%.9f")
